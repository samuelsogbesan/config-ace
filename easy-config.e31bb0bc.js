...
ConfigState.export = function () {
  var s = state();
  var binds = [];
  Object.keys(s).forEach(function (bindCode) {
    var bindString = "bind \"".concat(bindCode, "\" \"");
    Object.keys(s[bindCode]).forEach(function (command) {
      bindString = bindString.concat("".concat(command, " ").concat(s[bindCode][command], ";"));
    });
...
ConfigState.removeBind = function (bindCode, commandToRemove) {
  ...
  if (s[bindCode]) {
    console.log("removing s[".concat(bindCode, "][").concat(commandToRemove, "]"));
...
UIManagementTools.refreshBindCounter = function (bind) {
  ...
  if (binds) {
    var bindCount = Object.keys(binds).length;
...
module.exports = {
  ...
  "i": [{
    "command": "toggle",
    "value": " mat_monitorgamma 1.6 2.2"
  }],
  "m": [{
    "command": "teammenu",
    "value": ""
  ...
  "z": [{
    "command": "use",
    "value": " weapon_incgrenade"
  }],
  "kp_slash": [{
    "command": "toggle",
    "value": " gameinstructor_enable 1 0"
  }]
};
